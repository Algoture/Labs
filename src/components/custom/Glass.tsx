...
function Glass() {
  return (
    <main className="cen h-screen">
      <div className="min-w-72 p-4 backdrop-blur-lg bg-white/15 rounded-[20px]">
        ...
        <ul className="flex flex-col gap-1 mb-2">
          <p className="text-sm px-1 text-gray-300">Suggestions</p>
        ...
        <ul className="flex flex-col gap-1 border-t border-gray-100/20">
          <p className="text-sm px-1 text-gray-300 mt-1">Settings</p>
